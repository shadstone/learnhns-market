...
- The 17-test container suite proves that listing uploads validate the live owner coin, buying re-fetches the listing coin, sale and cancellation records validate the spending transaction, and transfer-finalization status reads live chain and name state.
...
| 2026-07-25 | Added live owner-coin validation to listing proof uploads and audited all transaction-sensitive paths | 17 container tests cover listing, buying, sale, cancellation, and transfer-finalization verification; final web deployment healthy at zero index lag |
